...
const PACKAGE_MANAGERS = [
  { command: "npm install blode-icons-react", value: "npm" },
  { command: "pnpm add blode-icons-react", value: "pnpm" },
  { command: "yarn add blode-icons-react", value: "yarn" },
  { command: "bun add blode-icons-react", value: "bun" },
] as const;
  ...
  <div className="group relative overflow-hidden rounded-xl bg-code text-code-foreground">
    <Tabs className="gap-0" defaultValue="npm">
      ...
      {PACKAGE_MANAGERS.map((pm) => (
        ...
        >
          <pre>
            <code className="font-mono text-sm leading-none">{pm.command}</code>
          </pre>
