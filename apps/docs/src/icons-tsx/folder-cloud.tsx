...
const FolderCloudIcon = (
  ...
  >
    <path
      ...
      d="M3 10V7c0-1.6569 1.3431-3 3-3h2.9296a2 2 0 0 1 1.6641.8906l.8126 1.2188A2 2 0 0 0 13.0704 7H18c1.6569 0 3 1.3431 3 3v6c0 1.6569-1.3431 3-3 3h-4"
    />
    <path
      stroke="currentColor"
...
export default createLucideIcon("FolderCloudIcon", ForwardRef);
