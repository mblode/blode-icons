...
const AmericanFootballFilledIcon = (
  ...
  >
    ...
    <path
      fill="currentColor"
      d="M2 15c0-.5074.029-1.0079.0856-1.5002l8.4146 8.4146A13.2 13.2 0 0 1 9 22H4c-1.1046 0-2-.8954-2-2zM21.9144 10.5002C21.9709 10.0079 22 9.5074 22 9V4c0-1.1046-.8954-2-2-2h-5c-.5074 0-1.0079.029-1.5002.0856z"
    />
  </svg>
);
