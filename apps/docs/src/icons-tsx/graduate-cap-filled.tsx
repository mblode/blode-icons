...
const GraduateCapFilledIcon = (
  ...
  >
    <path
      fill="currentColor"
      d="M12.4138 3.0896a1 1 0 0 0-.8276 0l-11 5a1.0002 1.0002 0 0 0 0 1.8208l11 5a1 1 0 0 0 .8276 0L22 10.553V16c0 .5523.4477 1 1 1s1-.4477 1-1V9c0-.3921-.2292-.7481-.5862-.9104z"
    />
    <path
      fill="currentColor"
      fillRule="evenodd"
