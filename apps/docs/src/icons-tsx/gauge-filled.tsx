...
const GaugeFilledIcon = (
  ...
  >
    ...
    <path
      fill="currentColor"
      d="M5.0429 5.0429c.3905-.3905 1.0237-.3905 1.4142 0l3.8778 3.8778A3.485 3.485 0 0 1 12 8.5c1.933 0 3.5 1.567 3.5 3.5s-1.567 3.5-3.5 3.5-3.5-1.567-3.5-3.5c0-.6028.1524-1.1699.4207-1.6651L5.0429 6.4571c-.3905-.3905-.3905-1.0237 0-1.4142"
    />
  </svg>
);
