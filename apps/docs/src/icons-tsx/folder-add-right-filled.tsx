...
const FolderAddRightFilledIcon = (
  ...
  >
    ...
    <path
      fill="currentColor"
      d="M8.7324 3c1.1263 0 2.178.5629 2.8028 1.5S13.2117 6 14.338 6H18c2.2091 0 4 1.7909 4 4v2.5278C20.9385 11.5777 19.5367 11 18 11c-3.3137 0-6 2.6863-6 6 0 1.0929.2922 2.1175.8027 3H6c-2.2091 0-4-1.7909-4-4V7c0-2.2091 1.7909-4 4-4z"
    />
  </svg>
);
