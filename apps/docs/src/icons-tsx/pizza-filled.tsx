...
const PizzaFilledIcon = (
  ...
  >
    ...
    <path
      fill="currentColor"
      d="M11.0008 6c0-.5652.1563-1.0938.428-1.5451l-4.2585.73c.5462 3.4851 2.3781 6.5439 4.9952 8.6755C12.6561 12.2064 14.1876 11 16.0008 11c1.4843 0 2.7799.8085 3.4702 2.0091l.7988-4.6598c.451-2.6307-1.7447-4.9281-4.35-4.6554.6606.5503 1.081 1.3791 1.081 2.306 0 1.657-1.3432 3-3 3s-3-1.343-3-3Z"
    />
    <path
      fill="currentColor"
