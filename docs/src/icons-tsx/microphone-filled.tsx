...
const MicrophoneFilledIcon = (props: SVGProps<SVGSVGElement>) => <svg xmlns="http://www.w3.org/2000/svg" width={24} height={24} fill="none" viewBox="0 0 24 24" {...props}><path fill="currentColor" d="M12.0014 2c-2.7614 0-5 2.2386-5 5v4c0 2.7614 2.2386 5 5 5s5-2.2386 5-5V7c0-2.7614-2.2386-5-5-5" style={{
    fill: "currentColor",
    fillOpacity: 1
