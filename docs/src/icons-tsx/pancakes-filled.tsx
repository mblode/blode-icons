...
const PancakesFilledIcon = (props: SVGProps<SVGSVGElement>) => <svg xmlns="http://www.w3.org/2000/svg" width={24} height={24} fill="none" viewBox="0 0 24 24" {...props}><path fill="currentColor" d="M3 5c0-.5523.4477-1 1-1h16c.5523 0 1 .4477 1 1s-.4477 1-1 1h-5c-.5523 0-1 .4477-1 1v3.5c0 .8284-.6716 1.5-1.5 1.5s-1.5-.6716-1.5-1.5v4c0 .8284-.6716 1.5-1.5 1.5S8 15.3284 8 14.5V7c0-.5523-.4477-1-1-1H4c-.5523 0-1-.4477-1-1" style={{
    fill: "currentColor",
    fillOpacity: 1
...
export default PancakesFilledIcon;
