...
const JudgeGavelFilledIcon = (props: SVGProps<SVGSVGElement>) => <svg xmlns="http://www.w3.org/2000/svg" width={24} height={24} fill="none" viewBox="0 0 24 24" {...props}><path stroke="currentColor" strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M2 13h2M5.5 9.5 4 8" style={{
    stroke: "currentColor",
    strokeOpacity: 1
...
export default JudgeGavelFilledIcon;
