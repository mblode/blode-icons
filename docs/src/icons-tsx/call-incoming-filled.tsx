...
const CallIncomingFilledIcon = (
  ...
  >
    ...
    />
    <path
      d="M20 9c0 .5523-.4477 1-1 1h-4c-.5523 0-1-.4477-1-1V5c0-.5523.4477-1 1-1s1 .4477 1 1v1.5858l3.2929-3.293c.3905-.3904 1.0237-.3904 1.4142 0 .3905.3906.3905 1.0238 0 1.4143L17.4142 8H19c.5523 0 1 .4477 1 1"
      fill="currentColor"
      style={{
        fill: "currentColor",
        fillOpacity: 1,
