...
const BezierPointerFilledIcon = (
  ...
  >
    <path
      clipRule="evenodd"
      d="M11.5357 13.3901c-.3233-1.1315.7229-2.1777 1.8544-1.8544l6.452 1.8435c1.2941.3697 1.4841 2.1249.2991 2.763l-2.5994 1.3996-1.3996 2.5994c-.6381 1.185-2.3933.995-2.763-.2991zm2.1703.3159 1.2583 4.4041.8877-1.6486a1.5 1.5 0 0 1 .6095-.6095l1.6486-.8877z"
      fill="currentColor"
      fillRule="evenodd"
      style={{
        fill: "currentColor",
