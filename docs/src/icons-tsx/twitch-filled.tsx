...
const TwitchFilledIcon = (props: SVGProps<SVGSVGElement>) => <svg xmlns="http://www.w3.org/2000/svg" width={24} height={24} fill="none" viewBox="0 0 24 24" {...props}><path fill="currentColor" d="M13.5421 6.6072h-1.5417v4.6071h1.5417zM17.3962 11.2143V6.6072h-1.5416v4.6071z" style={{
    fill: "currentColor",
    fillOpacity: 1
