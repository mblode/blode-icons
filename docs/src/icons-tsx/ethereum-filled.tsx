...
const EthereumFilledIcon = (props: SVGProps<SVGSVGElement>) => <svg xmlns="http://www.w3.org/2000/svg" width={24} height={24} fill="none" viewBox="0 0 24 24" {...props}><path fill="currentColor" d="m11.8181 13.7276-1.9975-.4994L12 16.2249l2.1794-2.9967-1.9975.4994a.75.75 0 0 1-.3638 0M12 12.2269l2.7396-.6849L12 7.7751 9.2604 11.542z" style={{
    fill: "currentColor",
    fillOpacity: 1
...
export default EthereumFilledIcon;
