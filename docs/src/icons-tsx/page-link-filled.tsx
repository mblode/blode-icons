...
const PageLinkFilledIcon = (props: SVGProps<SVGSVGElement>) => <svg xmlns="http://www.w3.org/2000/svg" width={24} height={24} fill="none" viewBox="0 0 24 24" {...props}><path fill="currentColor" d="M8 2C5.7909 2 4 3.7909 4 6v12c0 2.2091 1.7909 4 4 4h5.5278C12.5777 20.9385 12 19.5367 12 18v-3c0-3.3137 2.6863-6 6-6 .7013 0 1.3744.1203 2 .3414V6c0-2.2091-1.7909-4-4-4z" style={{
    fill: "currentColor",
    fillOpacity: 1
...
export default PageLinkFilledIcon;
