...
const Email3FilledIcon = (props: SVGProps<SVGSVGElement>) => <svg xmlns="http://www.w3.org/2000/svg" width={24} height={24} fill="none" viewBox="0 0 24 24" {...props}><path fill="currentColor" d="M21.8582 6.9406C21.3939 5.2456 19.8424 4 18 4H6C4.1576 4 2.6062 5.2456 2.1418 6.9406 4.672 9.45 8.155 11 12 11s7.328-1.55 9.8582-4.0594" style={{
    fill: "currentColor",
    fillOpacity: 1
...
export default Email3FilledIcon;
