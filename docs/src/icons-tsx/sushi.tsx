...
const SushiIcon = (props: SVGProps<SVGSVGElement>) => <svg xmlns="http://www.w3.org/2000/svg" width={24} height={24} fill="none" viewBox="0 0 24 24" {...props}><path stroke="currentColor" strokeLinecap="square" strokeWidth={2} d="M20 14.5V16c0 1.6569-1.3431 3-3 3H7c-1.6569 0-3-1.3431-3-3v-1.5" style={{
    ...
    stroke: "currentColor",
    strokeOpacity: 1
  }} /><path stroke="currentColor" strokeLinecap="square" strokeLinejoin="round" strokeWidth={2} d="M9 19V6.7237c0-1.4028.9743-2.6502 2.3759-2.7104a14.6 14.6 0 0 1 1.2482 0C14.0257 4.0735 15 5.321 15 6.7237V19" style={{
    stroke: "currentColor",
    strokeOpacity: 1
  }} /></svg>;
