...
const Back10sFilledIcon = (
  ...
  >
    <path
      clipRule="evenodd"
      d="M4.5588 10a1 1 0 0 0 .0458 0H8c.5523 0 1-.4477 1-1s-.4477-1-1-1H6.255c1.2655-1.8143 3.3678-3 5.7455-3 2.9361 0 5.4524 1.808 6.4916 4.3752.2072.512.7902.759 1.3021.5517.5119-.2072.759-.7902.5517-1.3021C19.0116 5.3283 15.7791 3 12.0005 3 9.1719 3 6.6494 4.3047 5 6.3436V5c0-.5523-.4477-1-1-1s-1 .4477-1 1v4c0 .5523.4477 1 1 1z"
      fill="currentColor"
      fillRule="evenodd"
      style={{
        fill: "currentColor",
