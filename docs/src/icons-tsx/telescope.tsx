...
const TelescopeIcon = (
  ...
  >
    <path
      d="m6.1318 10.4209-3.289 1.1971c-.7784.2833-1.1798 1.1441-.8965 1.9225l.342.9397c.2834.7785 1.1442 1.1799 1.9226.8965l3.289-1.197"
      stroke="currentColor"
      strokeLinecap="round"
