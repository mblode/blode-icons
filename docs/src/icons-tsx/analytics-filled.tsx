...
const AnalyticsFilledIcon = (props: SVGProps<SVGSVGElement>) => <svg xmlns="http://www.w3.org/2000/svg" width={24} height={24} fill="none" viewBox="0 0 24 24" {...props}><path fill="currentColor" d="M7 3C4.7909 3 3 4.7909 3 7v4h4.382a2 2 0 0 1 1.7888 1.1056L10 13.7639l3.1056-6.2111a1 1 0 0 1 1.7888 0L16.618 11H21V7c0-2.2091-1.7909-4-4-4z" style={{
    fill: "currentColor",
    fillOpacity: 1
