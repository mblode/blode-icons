...
const PageCloudFilledIcon = (
  ...
  >
    <path
      d="M8 2C5.7909 2 4 3.7909 4 6v12c0 2.2091 1.7909 4 4 4h3.1674C10.1326 20.8848 9.5 19.3913 9.5 17.75c0-3.4518 2.7982-6.25 6.25-6.25 1.6432 0 3.1372.6353 4.25 1.6678V6c0-2.2091-1.7909-4-4-4z"
      fill="currentColor"
      style={{
        fill: "currentColor",
        fillOpacity: 1,
