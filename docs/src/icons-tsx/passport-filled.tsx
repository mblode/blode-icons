...
const PassportFilledIcon = (props: SVGProps<SVGSVGElement>) => <svg xmlns="http://www.w3.org/2000/svg" width={24} height={24} fill="none" viewBox="0 0 24 24" {...props}><path fill="currentColor" d="M10.5 10.5c0-.8284.6716-1.5 1.5-1.5s1.5.6716 1.5 1.5S12.8284 12 12 12s-1.5-.6716-1.5-1.5" style={{
    fill: "currentColor",
    fillOpacity: 1
