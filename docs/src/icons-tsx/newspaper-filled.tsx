...
const NewspaperFilledIcon = (props: SVGProps<SVGSVGElement>) => <svg xmlns="http://www.w3.org/2000/svg" width={24} height={24} fill="none" viewBox="0 0 24 24" {...props}><path fill="currentColor" d="M8 11V9h3v2z" style={{
    fill: "currentColor",
    fillOpacity: 1
...
export default NewspaperFilledIcon;
