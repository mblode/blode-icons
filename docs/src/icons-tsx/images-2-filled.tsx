...
const Images2FilledIcon = (props: SVGProps<SVGSVGElement>) => <svg xmlns="http://www.w3.org/2000/svg" width={24} height={24} fill="none" viewBox="0 0 24 24" {...props}><path fill="currentColor" d="M14.5 7C13.1193 7 12 8.1193 12 9.5s1.1193 2.5 2.5 2.5S17 10.8807 17 9.5 15.8807 7 14.5 7" style={{
    fill: "currentColor",
    fillOpacity: 1
...
export default Images2FilledIcon;
