...
const BlossomIcon = (
  ...
  >
    ...
    />
    <path
      d="M12 15c1.6569 0 3-1.3431 3-3s-1.3431-3-3-3-3 1.3431-3 3 1.3431 3 3 3M9.5 9.5 8 8m6.5 1.5L16 8m-1.5 6.5L16 16m-6.5-1.5L8 16"
      stroke="currentColor"
      strokeLinecap="round"
      strokeLinejoin="round"
      strokeWidth={2}
