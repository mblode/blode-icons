...
const BezierAddFilledIcon = (
  ...
  >
    ...
    />
    <path
      d="M13 10c0-.5523-.4477-1-1-1s-1 .4477-1 1v1h-1c-.5523 0-1 .4477-1 1s.4477 1 1 1h1v1c0 .5523.4477 1 1 1s1-.4477 1-1v-1h1c.5523 0 1-.4477 1-1s-.4477-1-1-1h-1z"
      fill="currentColor"
      style={{
        fill: "currentColor",
        fillOpacity: 1,
