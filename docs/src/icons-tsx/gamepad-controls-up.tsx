...
const GamepadControlsUpIcon = (props: SVGProps<SVGSVGElement>, ref: Ref<SVGSVGElement>) => <svg xmlns="http://www.w3.org/2000/svg" width={24} height={24} fill="none" viewBox="0 0 24 24" ref={ref} {...props}><path fill="currentColor" stroke="currentColor" strokeLinecap="square" strokeLinejoin="round" strokeWidth={2} d="M13.5 3h-3C9.6716 3 9 3.6716 9 4.5v1.6287a1.5 1.5 0 0 0 .4393 1.0606L11.293 9.043c.3905.3905 1.0237.3905 1.4142 0l1.8536-1.8536A1.5 1.5 0 0 0 15 6.1287V4.5c0-.8284-.6716-1.5-1.5-1.5Z" style={{
    fill: "currentColor",
    fillOpacity: 1,
    stroke: "currentColor",
    strokeOpacity: 1
