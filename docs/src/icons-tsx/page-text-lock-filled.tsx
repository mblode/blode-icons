...
const PageTextLockFilledIcon = (props: SVGProps<SVGSVGElement>) => <svg xmlns="http://www.w3.org/2000/svg" width={24} height={24} fill="none" viewBox="0 0 24 24" {...props}><path fill="currentColor" fillRule="evenodd" d="M8 2C5.7909 2 4 3.7909 4 6v12c0 2.2091 1.7909 4 4 4h3.1707A3 3 0 0 1 11 21v-4c0-.9807.4706-1.8516 1.1983-2.399C12.8035 12.5205 14.7242 11 17 11a4.978 4.978 0 0 1 3 .9996V6c0-2.2091-1.7909-4-4-4zm0 3c-.5523 0-1 .4477-1 1s.4477 1 1 1h6c.5523 0 1-.4477 1-1s-.4477-1-1-1zm0 4c-.5523 0-1 .4477-1 1s.4477 1 1 1h3c.5523 0 1-.4477 1-1s-.4477-1-1-1z" clipRule="evenodd" style={{
    fill: "currentColor",
    fillOpacity: 1
...
export default PageTextLockFilledIcon;
