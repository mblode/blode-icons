...
const SignalIcon = (props: SVGProps<SVGSVGElement>) => <svg xmlns="http://www.w3.org/2000/svg" width={24} height={24} fill="none" viewBox="0 0 24 24" {...props}><g clipPath="url(#a)"><mask id="b" width={20} height={20} x={2} y={2} maskUnits="userSpaceOnUse" style={{
      maskType: "luminance"
        ...
        maskType: "luminance"
      }}><path fill="#fff" d="M-38.6523-12.8877H62.5179V167.061H-38.6523z" /></mask><g mask="url(#c)"><mask id="d" width={2} height={2} x={6} y={20} maskUnits="userSpaceOnUse" style={{
          maskType: "luminance"
        }}><path fill="#fff" d="m6.0879 20.1591.3338 1.0478a.24.24 0 0 0 .325.148l1.0043-.4381-.192-.4437-.7595.3315-.2526-.7931z" /></mask><g mask="url(#d)"><mask id="e" width={20} height={20} x={2} y={2} maskUnits="userSpaceOnUse" style={{
            maskType: "luminance"
          }}><path fill="#fff" d="M2.625 21.375h18.6153V2.6248H2.625z" /></mask><g mask="url(#e)"><mask id="f" width={3} height={3} x={5} y={19} maskUnits="userSpaceOnUse" style={{
              maskType: "luminance"
            }}><path fill="#fff" d="M5.998 21.375h1.7537v-1.4838H5.998z" /></mask><g mask="url(#f)"><mask id="g" width={2} height={2} x={6} y={20} maskUnits="userSpaceOnUse" style={{
                maskType: "luminance"
              }}><path fill="#fff" d="M7.753 20.0115v1.3635H6.0898v-1.3635z" /></mask><g mask="url(#g)"><path fill="currentColor" d="M6.0898 21.375H7.753v-1.3635H6.0898z" /></g><mask id="h" width={2} height={2} x={6} y={20} maskUnits="userSpaceOnUse" style={{
                maskType: "luminance"
              }}><path fill="#fff" d="M7.753 20.0115v1.3635H6.0898v-1.3635z" /></mask><g mask="url(#h)"><path fill="currentColor" d="M5.998 21.375h1.8886v-1.4838H5.998z" /></g></g></g></g></g><mask id="i" width={102} height={181} x={-39} y={-13} maskUnits="userSpaceOnUse" style={{
        maskType: "luminance"
      }}><path fill="#fff" d="M-38.6523-12.8877H62.5179V167.061H-38.6523z" /></mask><g mask="url(#i)"><mask id="j" width={20} height={19} x={2} y={2} maskUnits="userSpaceOnUse" style={{
          maskType: "luminance"
        }}><path fill="#fff" d="m10.6228 2.7111.0626.48a9.58 9.58 0 0 1 2.1091-.0427l.044-.482a10 10 0 0 0-.9067-.041c-.4387 0-.8787.0286-1.309.0857m3.0085.5521a9.2 9.2 0 0 1 2.0177.6148l.1912-.4441a9.67 9.67 0 0 0-2.1217-.6468zm-5.9772.3392.2103.4352a9.12 9.12 0 0 1 1.9897-.698l-.1062-.4727a9.63 9.63 0 0 0-2.0938.7355m8.7526.6493a8.82 8.82 0 0 1 1.7101 1.2326l.3257-.3571a9.3 9.3 0 0 0-1.804-1.2991zM5.1258 5.4071l.3414.3417a8.77 8.77 0 0 1 1.656-1.306L6.873 4.029a9.27 9.27 0 0 0-1.7473 1.378m13.5837.6796c.4726.5316.8732 1.1165 1.1905 1.739l.4282-.2214a8.72 8.72 0 0 0-1.2599-1.8401zM3.3548 7.9691l.4387.2c.2873-.6365.6605-1.2393 1.108-1.7914l-.3727-.3068c-.4747.585-.8698 1.2232-1.174 1.8982m16.8883.628a7.86 7.86 0 0 1 .4811 2.0508l.4789-.0465a8.3 8.3 0 0 0-.5107-2.1784zM2.6267 11.0046l.4806.0226a7.86 7.86 0 0 1 .3803-2.0713l-.4573-.1515a8.28 8.28 0 0 0-.4036 2.2002m17.8242 2.5705.4624.1353a8.32 8.32 0 0 0 .327-2.213l-.4814-.006a7.82 7.82 0 0 1-.308 2.0837M2.625 11.895c.0254.8213.1155 1.5436.2742 2.207l.4683-.113c-.151-.6315-.2365-1.3218-.261-2.1094zm16.5 4.3048.3824.2931a8.62 8.62 0 0 0 1.1106-1.9365l-.4451-.1839a8.15 8.15 0 0 1-1.0479 1.8273M3.1568 14.963c.2687.7342.6334 1.3733 1.116 1.9506l.369-.3106c-.4463-.535-.7844-1.1255-1.0327-1.8068zm13.8096 3.2399.2623.4057a9.18 9.18 0 0 0 1.7037-1.4322l-.3515-.3307a8.75 8.75 0 0 1-1.6145 1.3572m-12.07-.6387c.1566.1434.3238.2829.4985.4156l.423 1.3302.4587-.148-.4468-1.4032a.243.243 0 0 0-.0855-.1208 6.9 6.9 0 0 1-.5241-.4322zm9.3733 1.8239.1193.4689a9.62 9.62 0 0 0 2.0718-.7966l-.2229-.4296a9.09 9.09 0 0 1-1.9682.7573m-4.3868.0708-1.5282.6669.192.4445 1.45-.6335c.1641.0452.297.0793.4142.1058l.1066-.4723a10.4 10.4 0 0 1-.4747-.1225.24.24 0 0 0-.0643-.0089.24.24 0 0 0-.0956.02m2.0464.2236c-.2479 0-.4345-.0013-.5991-.0073l-.0178.4843c.1722.0059.3639.0072.6169.0072.5335 0 1.0687-.0431 1.5903-.1271l-.077-.4787a9.4 9.4 0 0 1-1.5133.1216" /></mask><g mask="url(#j)"><mask id="k" width={20} height={20} x={2} y={2} maskUnits="userSpaceOnUse" style={{
            maskType: "luminance"
          }}><path fill="#fff" d="M2.625 21.375h18.6153V2.6248H2.625z" /></mask><g mask="url(#k)"><mask id="l" width={20} height={19} x={2} y={2} maskUnits="userSpaceOnUse" style={{
              maskType: "luminance"
            }}><path fill="#fff" d="M2.625 20.7012h18.6153V2.6254H2.625z" /></mask><g mask="url(#l)"><mask id="m" width={20} height={19} x={2} y={2} maskUnits="userSpaceOnUse" style={{
                maskType: "luminance"
              }}><path fill="#fff" d="M21.2403 2.6254v17.9449H2.625V2.6253z" /></mask><g mask="url(#m)"><path fill="currentColor" d="M2.625 20.5703h18.6153V2.6253H2.625z" /></g><mask id="n" width={20} height={19} x={2} y={2} maskUnits="userSpaceOnUse" style={{
                maskType: "luminance"
              }}><path fill="#fff" d="M21.2403 2.6254v17.9449H2.625V2.6253z" /></mask><g mask="url(#n)"><path fill="currentColor" d="M2.625 20.7012h18.6153V2.6254H2.625z" /></g></g></g></g></g><mask id="o" width={102} height={181} x={-39} y={-13} maskUnits="userSpaceOnUse" style={{
        maskType: "luminance"
      }}><path fill="#fff" d="M-38.6523-12.8877H62.5179V167.061H-38.6523z" /></mask><g mask="url(#o)"><mask id="p" width={16} height={16} x={4} y={4} maskUnits="userSpaceOnUse" style={{
          maskType: "luminance"
