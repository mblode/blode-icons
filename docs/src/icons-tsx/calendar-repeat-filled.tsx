...
const CalendarRepeatFilledIcon = (props: SVGProps<SVGSVGElement>) => <svg xmlns="http://www.w3.org/2000/svg" width={24} height={24} fill="none" viewBox="0 0 24 24" {...props}><path fill="currentColor" d="M8 2c.5523 0 1 .4477 1 1v1h6V3c0-.5523.4477-1 1-1s1 .4477 1 1v1c2.2091 0 4 1.7909 4 4v1c0 .5523-.4477 1-1 1H5v7c0 1.1046.8954 2 2 2h3c.5523 0 1 .4477 1 1s-.4477 1-1 1H7c-2.2091 0-4-1.7909-4-4V8c0-2.2091 1.7909-4 4-4V3c0-.5523.4477-1 1-1" style={{
    fill: "currentColor",
    fillOpacity: 1
...
export default CalendarRepeatFilledIcon;
