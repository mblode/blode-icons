...
const ChromecastFilledIcon = (props: SVGProps<SVGSVGElement>) => <svg xmlns="http://www.w3.org/2000/svg" width={24} height={24} fill="none" viewBox="0 0 24 24" {...props}><path fill="currentColor" d="M6 3C3.7909 3 2 4.7909 2 7v.0379Q2.4951 7 3 7c7.1797 0 13 5.8203 13 13q-.0001.5049-.0379 1H18c2.2091 0 4-1.7909 4-4V7c0-2.2091-1.7909-4-4-4zM3 13c-.5523 0-1 .4477-1 1s.4477 1 1 1c2.7614 0 5 2.2386 5 5 0 .5523.4477 1 1 1s1-.4477 1-1c0-3.866-3.134-7-7-7" style={{
    fill: "currentColor",
    fillOpacity: 1
...
export default ChromecastFilledIcon;
