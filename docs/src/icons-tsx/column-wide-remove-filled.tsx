...
const ColumnWideRemoveFilledIcon = (props: SVGProps<SVGSVGElement>) => <svg xmlns="http://www.w3.org/2000/svg" width={24} height={24} fill="none" viewBox="0 0 24 24" {...props}><path fill="currentColor" d="M18 6h-5v13c0 .5523-.4477 1-1 1H6c-2.2091 0-4-1.7909-4-4V8c0-2.2091 1.7909-4 4-4h12c2.2091 0 4 1.7909 4 4v2c0 .5523-.4477 1-1 1s-1-.4477-1-1V8c0-1.1046-.8954-2-2-2" style={{
    fill: "currentColor",
    fillOpacity: 1
...
export default ColumnWideRemoveFilledIcon;
