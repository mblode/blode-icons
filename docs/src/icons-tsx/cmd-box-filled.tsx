...
const CmdBoxFilledIcon = (
  ...
  >
    <path
      d="M9 8.5V9h-.5a.5.5 0 1 1 .5-.5M11 13v-2h2v2zM8.5 15H9v.5a.5.5 0 1 1-.5-.5M15 15.5V15h.5a.5.5 0 1 1-.5.5M15.5 9H15v-.5a.5.5 0 1 1 .5.5"
      fill="currentColor"
      style={{
        fill: "currentColor",
        fillOpacity: 1,
