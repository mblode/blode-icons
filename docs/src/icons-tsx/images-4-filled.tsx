...
const Images4FilledIcon = (props: SVGProps<SVGSVGElement>) => <svg xmlns="http://www.w3.org/2000/svg" width={24} height={24} fill="none" viewBox="0 0 24 24" {...props}><path fill="currentColor" fillRule="evenodd" d="M9 3C7.067 3 5.5 4.567 5.5 6.5S7.067 10 9 10s3.5-1.567 3.5-3.5S10.933 3 9 3M7.5 6.5C7.5 5.6716 8.1716 5 9 5s1.5.6716 1.5 1.5S9.8284 8 9 8s-1.5-.6716-1.5-1.5" clipRule="evenodd" style={{
    fill: "currentColor",
    fillOpacity: 1
...
export default Images4FilledIcon;
