...
const HdFilledIcon = (props: SVGProps<SVGSVGElement>) => <svg xmlns="http://www.w3.org/2000/svg" width={24} height={24} fill="none" viewBox="0 0 24 24" {...props}><path fill="currentColor" d="M15.3984 13.8545h-.6494v-3.7549h.6494c.9912 0 1.5772.6397 1.5772 1.8262 0 1.2988-.542 1.9287-1.5772 1.9287" style={{
    fill: "currentColor",
    fillOpacity: 1
