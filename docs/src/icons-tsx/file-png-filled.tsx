...
const FilePngFilledIcon = (props: SVGProps<SVGSVGElement>) => <svg xmlns="http://www.w3.org/2000/svg" width={24} height={24} fill="none" viewBox="0 0 24 24" {...props}><path fill="currentColor" d="M13 3H8C5.7909 3 4 4.7909 4 7v5h16v-2h-4c-1.6569 0-3-1.3431-3-3z" style={{
    fill: "currentColor",
    fillOpacity: 1
