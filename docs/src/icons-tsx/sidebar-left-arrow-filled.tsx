...
const SidebarLeftArrowFilledIcon = (props: SVGProps<SVGSVGElement>) => <svg xmlns="http://www.w3.org/2000/svg" width={24} height={24} fill="none" viewBox="0 0 24 24" {...props}><path fill="currentColor" d="M7 3C4.7909 3 3 4.7909 3 7v10c0 2.2091 1.7909 4 4 4z" style={{
    fill: "currentColor",
    fillOpacity: 1
...
export default SidebarLeftArrowFilledIcon;
